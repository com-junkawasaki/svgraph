...
- Added `svgraph` as the canonical typed Python import package and console-script entry point target, while preserving `drawingml_svg` and `drawingml-svg` compatibility surfaces.
