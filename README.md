...
- Analysis: unsupported visual attributes such as filters, masks, fill/clip rules, paint order, vector effects, unsupported markers, and unresolved paint servers are reported
