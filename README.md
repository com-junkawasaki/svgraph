...
- `web/app.ts` builds SVGraph, browser-local coverage diagnostics, an SVGraph presentation package projection, DrawingML fragment XML, PresentationML slide XML, and a `.pptx` ZIP without Python or server APIs.
